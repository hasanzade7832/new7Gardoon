...
const SliderDetails = ({ midBanId }) => {
   ...
   const updater = (e) => {
      ...
      const url = `https://7gardoon-servers.liara.run/api/update-slider/${midBanId}`;
      axios
         .post(url, formData)
         .then((d) => {
   ...
   useEffect(() => {
      axios
         .get(
            `https://7gardoon-servers.liara.run/api/get-slider/${midBanId}`
         )
         .then((d) => {
            setfullData(d.data);
         })
   ...
   const remover = () => {
      const url = `https://7gardoon-servers.liara.run/api/delete-slider/${midBanId}`;
      axios
         .post(url)
         .then((d) => {
