...
const MidBannerDetails = ({ midBanId }) => {
   ...
   const updater = (e) => {
      ...
      const url = `https://7gardoon-servers.liara.run/api/update-middle-banner/${midBanId}`;
      axios
         .post(url, formData)
         .then((d) => {
   ...
   useEffect(() => {
      axios
         .get(
            `https://7gardoon-servers.liara.run/api/get-mid-ban/${midBanId}`
         )
         .then((d) => {
            setfullData(d.data);
         })
   ...
   const remover = () => {
      const url = `https://7gardoon-servers.liara.run/api/delete-middle-banner/${midBanId}`;
      axios
         .post(url)
         .then((d) => {
